...
$(window).load(function() {
  ...
  if ($customScrollBox_container.height() < $(window).height()) {
    $customScrollBox.height('100%');
  } else {
  ...
  function SlidePanels(action){
    ...
    if(action=="open"){
      ...
      $bg.stop().animate({left: 0}, speed,easing);
    } else {
...
var images=["/assets/ajax-loader_dark.gif","/assets/round_custom_scrollbar_bg_over.png"];
